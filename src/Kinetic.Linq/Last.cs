...
public static partial class Observable
{
    ...
    private readonly struct LastStateMachineFactory<TSource> : IObserverStateMachineFactory<TSource, TSource>
    {
    ...
    private struct LastStateMachine<TContinuation, TSource> : IObserverStateMachine<TSource>
        where TContinuation : struct, IObserverStateMachine<TSource>
    {
