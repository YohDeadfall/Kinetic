...
{
    public static ObserverBuilder<TSource> TakeWhile<TSource>(this ObserverBuilder<TSource> source, Func<TSource, bool> predicate) =>
    ...
    private readonly struct TakeWhileStateMachineFactory<TSource> : IStateMachineFactory<TSource, TSource>
    {
