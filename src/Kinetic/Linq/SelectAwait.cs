    ...
    where TOperator : IOperator<TSource>
{
    ...
    {
        return _source.Build<TBox, TBoxFactory, TransformAwaitStateMachine<TContinuation, AwaiterForValueTaskFactory<TSource, TResult>, AwaiterForValueTask<TResult>, TSource, TResult>>(
